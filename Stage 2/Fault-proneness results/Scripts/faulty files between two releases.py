#faulty files using pydriller and fault inducing commits includes all the java and c/c++ files
import os
import csv
...
results = detect_fault_inducing_commits(
    repo_path="cloned_abidi_latest/pljava", # path to the projects to be analyzed for faulty files
    release_pairs=release_pairs_to_analyze,
    output_dir="buggy_smelly/abidi/general_faulty" #path to output
)
